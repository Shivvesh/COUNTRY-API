...
#Setting labels
city_name_label=Label(root, text="Capital City Name",font=("Helvetica", 18,'bold'),bg="gray", fg="white")
city_name_label.place(relx=0.35,rely=0.15,anchor=CENTER)

city_entry=Entry(root)
city_entry.place(relx=0.24,rely=0.25,anchor=CENTER)

country_name = Label(root,text="Country:", bg="gray",fg="White", font=("Helvetica",10,"bold"))
country_name.place(relx=0.06,rely=0.45,anchor=W) 

region = Label(root,text="Region:", bg="gray", fg="white", font=("Helvetica",10,"bold")) 
region.place(relx=0.06,rely=0.55,anchor=W) 

language = Label(root,text="Language:", bg="gray", fg="white", font=("Helvetica",10,"bold")) 
language.place(relx=0.06,rely=0.65,anchor=W) 

population= Label(root,text="Population:", bg="gray", fg="white", font=("Helvetica",10,"bold")) 
population.place(relx=0.06,rely=0.75,anchor=W) 

area = Label(root,text="Area:",bg="gray", fg="white", font=("Helvetica",10,"bold")) 
